...
public class ContactManager {
    ...
    public boolean update(String fullName, String phoneNumber, String group, String gender, String address, String birth, String mail) {
        for (Contact c : contacts) {
    ...
    public boolean searchFullName(String fullName){
        for (Contact c : contacts){
            if (c.getFullName().contains(fullName)){
                System.out.println(c.toString());
            }
        }
        return true;
    ...
    public void readFile(String filePath) {
        ContactCSV csvManager = new ContactCSV();
